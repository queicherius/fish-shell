# DO NOT EDIT THIS FILE DIRECTLY. INSTEAD, EDIT THIS GIST AND RUN THE SELF-UPDATE
# https://gist.github.com/queicherius/35a6cdd2130026fd70181ba20c8fd7dc

# Install:
# 1) sudo ln -s /mnt/c/David/Projects/ /Projects
# 2) curl https://gist.githubusercontent.com/queicherius/35a6cdd2130026fd70181ba20c8fd7dc/raw > ~/.config/fish/config.fish
...
function fish_config_update
  curl -H 'Cache-Control: no-cache' https://gist.githubusercontent.com/queicherius/35a6cdd2130026fd70181ba20c8fd7dc/raw > ~/.config/fish/config.fish
...
# Skip git cleanup for `np`, every time
function np
  command np $argv --skip-cleanup
end
...
# Show what the user did in a repository recently
